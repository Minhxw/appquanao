    ...
    <View style={styles.container}>
      ...
      <View style={styles.wrapProduct}>
        ...
        <View>
          ...
          <TouchableOpacity onPress={onRemove} style={{borderWidth:1,borderColor:'#ccc',borderRadius:30, height:50,width:100,justifyContent:'center',backgroundColor:'red'}}>
            <Text style={{fontSize:20,color:'#fff',marginRight:10,textAlign:'center'}}>Xóa</Text>
        </TouchableOpacity>
        </View>
      </View>
    </View>
